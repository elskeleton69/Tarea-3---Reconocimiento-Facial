...
<div class="card">
    <button type="button" class="btn btn-outline-secondary" onclick="sucursales(); roles()" data-bs-toggle="modal"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="Cedula" id="Cedula" class="form-control"
                            placeholder="Ingrese su Cedula" require>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <video id="video" width="300" height="300" autoplay muted style="position: absolute; ">
